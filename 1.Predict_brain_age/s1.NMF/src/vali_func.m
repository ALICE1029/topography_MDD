function [U, V] = vali_func(path,file_name,si,mask,prepData,outDir,resId,initName,K,alphaS21,alphaL,spaR,vxI,ard,eta,iterNum,calcGrp,parforOn)
...
sbjData = prepareFuncData_vol_func_single(path,file_name,mask,'');%%change
alphaS1 = alphaS21;
...
fprintf('\n');
initUvName = [resDir,filesep,num2str(si),'init_UV.mat'];
...
finalUvName = [resDir,filesep,num2str(si),'final_UV.mat'];
